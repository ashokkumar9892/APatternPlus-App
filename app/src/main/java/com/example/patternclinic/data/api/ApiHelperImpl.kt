...
class ApiHelperImpl @Inject constructor(private val apiService: ApiService) : ApiHelper {
    ...
    override suspend fun signUp(map: HashMap<String, Any>): Response<BasicResponse> = apiService.signUp(map)
    ...
    override suspend fun manageNotification(map: HashMap<String, Any>): Response<BasicResponse> = apiService.manageNotification(map)
    override suspend fun createAppointment(map: HashMap<String, Any>): Response<BasicResponse> = apiService.createAppointment(map)
